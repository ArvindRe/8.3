...
and lower(f.name) like 'tennis%'
and m.memid=m.memid 
group by name, MemberName
order by MemberName
...
select b.*  from Facilities f, Bookings b where 
b.facid=f.facid and starttime LIKE '2012-09-14%' and (membercost>30 or guestcost>30)


/* Q9: This time, produce the same result as in Q8, but using a subquery. */
select * from Bookings where bookid in (
select bookid  from Facilities f, Bookings b where 
b.facid=f.facid and starttime LIKE '2012-09-14%' and (membercost>30 or guestcost>30)
)

/* PART 2: SQLite

Export the country club data from PHPMyAdmin, and 
...
select memid,facid, sum(slots) as "Total Slots"
